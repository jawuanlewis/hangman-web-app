...
const Footer = () => {
  return (
    <footer>
      <ul>
        <li><a target="_blank" href="https://www.linkedin.com/in/jawuan-lewis">
          <img src={linkedinLogo} className="item-hover" />
        </a></li>
        <li><a target="_blank" href="https://github.com/jawuanlewis">
      ...
      <div className="icon-desc">Icons by <a target="_blank" href="https://icons8.com">Icons8</a></div>
    </footer>
  );
};
